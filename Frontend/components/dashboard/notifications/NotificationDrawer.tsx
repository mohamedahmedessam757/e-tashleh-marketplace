...
export const NotificationDrawer: React.FC<NotificationDrawerProps> = ({
    ...
    // AR: open from left (الشمال); EN: open from right — matches other drawers (e.g. OrderFinancialDrawer)
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] overflow-hidden">
                    ...
                    <motion.div
                        ...
                        className={`absolute top-0 bottom-0 ${isAr ? 'left-0 border-e' : 'right-0 border-s'} w-full max-w-[400px] bg-[#0A0A0A] border-white/5 shadow-[0_0_50px_rgba(0,0,0,0.5)] z-[110] flex flex-col`}
                    >
