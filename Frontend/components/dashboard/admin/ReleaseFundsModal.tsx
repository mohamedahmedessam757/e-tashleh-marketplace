...
import { X, RotateCcw, FileSignature, Loader2 } from 'lucide-react';
      ...
      <div className="relative w-full max-w-lg bg-[#0F1014] rounded-2xl border border-amber-500/20 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <form id="release-funds-form" onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full h-24 bg-[#1A1B23] border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-amber-500/50 resize-none disabled:opacity-50"
              />
            </div>
            <div className="p-5 bg-amber-500/5 border border-amber-500/20 rounded-xl space-y-4">
              ...
              <input
                ...
                className="w-full bg-[#14151A] border border-amber-500/20 rounded-lg px-4 py-2.5 text-amber-400 font-mono text-sm outline-none disabled:opacity-50"
              />
            </div>
          </form>
        </div>
        <div className="p-6 border-t border-white/5 bg-[#14151A] flex gap-3">
          ...
          <button
            ...
            disabled={isProcessing}
            className="flex-[2] py-3 rounded-xl bg-amber-500/10 hover:bg-amber-500 border border-amber-500/20 text-amber-500 hover:text-black text-sm font-black uppercase disabled:opacity-50 inline-flex items-center justify-center gap-2"
          >
