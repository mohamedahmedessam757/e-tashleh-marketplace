  ...
  ar: {
    ...
    disputeManager: {
      ...
      verdictTerminal: {
        ...
        warrantyExchange: 'الضمان (استبدال بدون استرداد)',
        warrantyExchangeHint:
          'مسار الضمان: لا استرداد نقدي للعميل ولا رسوم منصة على التاجر — فقط شحن ذهاباً وإياباً. بعد دفع التاجر تُصدر بوليصة الإرجاع وتُفتح القطعة للشحن البديل مع توضيح اسم القطعة ومدة الضمان.',
        ...
        feeGovernanceCustomer: 'العميل (إدعاء): تُصفَّر الحاسبة تلقائياً — لا استرداد للعميل ولا غرامة على التاجر.',
        ...
        feeGovernanceWarranty: 'الضمان: لا استرداد نقدي ولا رسوم منصة — التاجر يدفع شحن الذهاب والإياب فقط، ثم تُصدر بوليصة الإرجاع ويُفتح شحن البديل.',
    ...
    billing: {
      ...
      kpis: {
        ...
        logisticsRevenue: 'رسوم الشحن المستحقة لشركة الشحن',
        logisticsSub: 'إجمالي شحن الطلبات المستحق لحساب شركة الشحن — ليس ربح المنصة',
      ...
      panels: {
        ...
        settlement: 'التسويات',
        shippingCompanyObligations: 'التزامات شركة الشحن',
        penalties: 'الغرامات',
        reports: 'التقارير',
      ...
      reports: {
        ...
        descriptions: {
          ...
          'shipping-collected': 'إجمالي رسوم الشحن المستحقة لشركة الشحن من الطلبات (يومياً)',
        ...
        columns: {
          ...
          shippingCollected: 'الشحن المستحق لشركة الشحن',
          dailyTxCount: 'عمليات اليوم',
          monthlyTxCount: 'عمليات الشهر',
        ...
        types: {
          ...
          'shipping-collected': 'رسوم الشحن المستحقة لشركة الشحن',
  ...
  en: {
    ...
    disputeManager: {
      ...
      verdictTerminal: {
        ...
        warrantyExchange: 'Warranty (replacement, no refund)',
        warrantyExchangeHint:
          'Warranty path: no cash refund and no platform fees — merchant pays round-trip shipping only. After payment, the return label is issued and the part opens for replacement shipping with part name and warranty duration.',
        ...
        feeGovernanceCustomer: 'Customer claim: calculator auto-zeros — no customer refund and no merchant fine.',
        ...
        feeGovernanceWarranty: 'Warranty: no cash refund and no platform fees — merchant pays round-trip shipping only, then return label issues and replacement shipping opens.',
    ...
    billing: {
      ...
      kpis: {
        ...
        logisticsRevenue: 'Shipping Due to Carrier',
        logisticsSub: 'Total order shipping owed to the shipping company account — not platform profit',
      ...
      panels: {
        ...
        shippingCompanyObligations: 'Shipping Company Obligations',
        penalties: 'Penalties',
        reports: 'Reports',
      ...
      reports: {
        ...
        descriptions: {
          ...
          'shipping-collected': 'Total order shipping owed to the shipping company (daily)',
        ...
        columns: {
          ...
          shippingCollected: 'Shipping Due to Carrier',
          dailyTxCount: 'Daily Transactions',
          monthlyTxCount: 'Monthly Transactions',
        ...
        types: {
          ...
          'shipping-collected': 'Shipping Due to Carrier',
