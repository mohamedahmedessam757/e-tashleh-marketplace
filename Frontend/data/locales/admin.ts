  ...
  ar: {
    ...
    disputeManager: {
      ...
      verdictTerminal: {
        ...
        closeCompleteRefund: 'قفل الطلب كمنتهٍ واسترداد المبلغ للعميل',
        closeCompleteRefundHint: 'يُغلق الطلب بحالة «منتهٍ» ويُسترد للعميل صافي المبلغ فقط وفق الحاسبة. باقي المبلغ (رسوم البوابة والاسترداد) يُسجَّل لحساب المنصة.',
  ...
  en: {
    ...
    disputeManager: {
      ...
      verdictTerminal: {
        ...
        closeCompleteRefund: 'Close order as completed and refund customer',
        closeCompleteRefundHint: 'The order is closed as completed. Only the net refund (per calculator) goes to the customer. Gateway and refund fees are retained by the platform.',
