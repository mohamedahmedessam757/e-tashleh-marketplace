...
export class OrderStateMachine {
    ...
    private readonly TRANSITION_RULES: Record<OrderStatus, OrderStatus[]> = {
        ...
        [OrderStatus.DELIVERED]: [OrderStatus.COMPLETED, OrderStatus.WARRANTY_ACTIVE, OrderStatus.CLOSED, OrderStatus.RETURN_REQUESTED, OrderStatus.RETURNED, OrderStatus.DISPUTED],
        [OrderStatus.WARRANTY_ACTIVE]: [OrderStatus.WARRANTY_EXPIRED, OrderStatus.RETURN_REQUESTED, OrderStatus.RETURNED, OrderStatus.DISPUTED, OrderStatus.CLOSED],
